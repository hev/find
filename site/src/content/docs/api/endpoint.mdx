...
description: "The /api/ask route contract: suggestions, keyless knowledge-graph reads, keyword JSON, agentic SSE, mode selection, and error responses."
group: "API"
order: 2
---
...
warning if they differ — your cue to run [`ask kg build`](/docs/api/cli).
